  ...
  return (
    <div className="relative overflow-hidden bg-cream-dark px-6 py-10 md:px-16">
      <div
        ...
        style={{
          backgroundImage:
            "url(https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=600&q=60)",
        }}
      />
...
function ContactItem({
  ...
  return (
    <div className="flex items-center gap-3">
      <svg
        viewBox="0 0 24 24"
        className="h-[18px] w-[18px] stroke-forest"
        fill="none"
        strokeWidth="1.5"
      >
      ...
      <div className="text-[0.78rem] text-ink-mid">
        ...
        <br />
        {to ? (
          <Link to={to} className="font-medium text-forest">
            {link}
          </Link>
        ) : (
          <a
