    ...
    <section className="relative flex min-h-screen flex-col justify-end overflow-hidden px-6 pb-20 pt-32 md:px-16 md:pb-24">
      ...
      <div className="pointer-events-none absolute right-0 top-20 z-[2] h-80 w-72 opacity-55">
        <svg viewBox="0 0 280 320" xmlns="http://www.w3.org/2000/svg">
          <g fill="none" stroke="#4a7a3a" strokeWidth="1.2" opacity="0.6">
            <path
              d="M240,10 C220,40 180,60 200,120 C210,150 230,140 240,180"
              stroke="#3d6b3d"
              strokeWidth="2"
            />
            <ellipse
              ...
              rx="35"
              ry="14"
              fill="rgba(61,107,61,0.25)"
              transform="rotate(-30 210 65)"
            />
            <ellipse
              cx="225"
              cy="100"
              rx="30"
              ry="11"
              fill="rgba(61,107,61,0.2)"
              transform="rotate(-15 225 100)"
            />
            <ellipse
              cx="235"
              cy="140"
              ...
              transform="rotate(-5 235 140)"
            />
            <path
              d="M270,0 C260,30 245,50 255,90 C260,110 270,105 275,130"
              stroke="#2d4a2d"
              strokeWidth="1.5"
              opacity="0.7"
            />
            <ellipse
              ...
              rx="25"
              ry="9"
              fill="rgba(45,74,45,0.2)"
              transform="rotate(-40 258 45)"
            />
            <ellipse
              cx="265"
              cy="80"
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 z-[2] h-56 w-52 opacity-45">
        <svg viewBox="0 0 200 220" xmlns="http://www.w3.org/2000/svg">
          <g fill="none">
            <path
              d="M10,220 C20,190 40,170 25,130 C18,108 8,115 5,85"
              stroke="#6b9b6b"
              strokeWidth="2"
              opacity="0.8"
            />
            <ellipse
              ...
              rx="32"
              ry="12"
              fill="rgba(107,155,107,0.3)"
              transform="rotate(25 22 165)"
            />
            <ellipse
              cx="16"
              cy="130"
              rx="28"
              ry="10"
              fill="rgba(107,155,107,0.25)"
              transform="rotate(15 16 130)"
            />
            <path
              d="M50,220 C55,195 65,178 55,148 C50,132 40,137 38,112"
              stroke="#4a7a3a"
              strokeWidth="1.5"
              opacity="0.6"
            />
            <ellipse
              ...
              rx="26"
              ry="9"
              fill="rgba(61,107,61,0.22)"
              transform="rotate(20 53 178)"
            />
            <ellipse
              cx="47"
              cy="150"
