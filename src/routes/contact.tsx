  ...
  head: () => ({
    meta: [
      { title: "Contact & Brochure — Pura Vida Villas | EarthAroma" },
      {
        name: "description",
        content:
          "Request the EarthAroma brochure pack, schedule a site visit, or talk to our sales team. Bengaluru — IGBC Platinum eco-villas.",
      },
  ...
  return (
    <>
      <PageHeader
        ...
        title={
          <>
            Schedule a <em>Site Visit</em>
          </>
        }
        intro="Receive the full villa specification sheet, floor plans, pricing guide, and EarthAroma brochure — free, instantly."
      />
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-12 md:grid-cols-[1fr_1.1fr]">
          <FadeUp className="space-y-6">
            <div>
              ...
              <a href={site.phoneHref} className="block font-display text-3xl text-forest">
                {site.phone}
              </a>
            </div>
            <div>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="font-display text-xl text-forest underline-offset-4 hover:underline"
              >
          ...
          <FadeUp delay={0.1} className="rounded-lg bg-cream p-8 md:p-10">
            ...
            <p className="mt-2 text-[0.85rem] leading-[1.6] text-ink-muted">
              Receive the full villa spec sheet, floor plans, pricing guide, and EarthAroma brochure
              — free, instantly.
            </p>
            <div className="mt-6 flex items-start gap-3 rounded border border-dashed border-forest/20 bg-forest/[0.06] p-4">
              ...
              <p className="text-[0.78rem] leading-[1.5] text-ink-mid">
                <strong>Inside the Brochure Pack:</strong> Complete spec sheet (7 categories) · 4
                floor plans with dimensions · Pricing guide · Site map · Clubhouse details
              </p>
            </div>
            <form
            ...
            >
              ...
              <label className="flex items-start gap-3 text-[0.75rem] leading-[1.5] text-ink-muted">
                ...
                <span>
                  I consent to being contacted by the Pura Vida Villas team via call or WhatsApp
            ...
            {submitting === "sent" && (
              <div className="mt-4 rounded border border-forest/20 bg-forest/5 p-4 text-center">
                <p className="text-sm text-forest">
                  If your brochure didn't open automatically, click below:
                </p>
                <a
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="btn-outline-forest mt-4 block w-full text-center"
            >
              Chat on WhatsApp
            </a>
          </FadeUp>
        ...
        <div className="mx-auto max-w-6xl text-center">
          <FadeUp>
            ...
            <h2 className="section-title mt-4">
              Experience Pura Vida <em>in Person</em>
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-[0.93rem] leading-[1.8] text-ink-mid">
              The best way to appreciate the biophilic design and lakeside serenity of EarthAroma is
              to see it for yourself. Book a private site tour at your convenience.
            </p>
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              ...
              <a href={site.maps} target="_blank" rel="noreferrer" className="btn-outline-forest">
                Get Directions
              </a>
            </div>
          </FadeUp>
...
function Field({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div>
      <label className="mb-1.5 block text-[0.7rem] uppercase tracking-[0.1em] text-ink-mid">
        {label}
      </label>
      {children}
    </div>
