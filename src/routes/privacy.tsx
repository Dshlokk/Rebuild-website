  ...
  head: () => ({
    meta: [
      { title: "Privacy Policy — Pura Vida Villas | EarthAroma" },
      {
        name: "description",
        content:
          "Privacy Policy for Pura Vida Villas and EarthAroma. Your privacy and data security are our top priorities.",
      },
    ],
  }),
        ...
        <div className="mx-auto max-w-4xl space-y-10 text-ink-mid">
          <FadeUp className="space-y-4">
            ...
            <p className="text-[0.95rem] leading-[1.8]">
              We collect information that you provide directly to us when you request a brochure,
              schedule a site visit, or contact our sales team. This may include your name, email
              address, phone number, and preferences regarding our property offerings.
            </p>
          </FadeUp>
          ...
          <FadeUp delay={0.1} className="space-y-4">
            ...
            <p className="text-[0.95rem] leading-[1.8]">
              The information we collect is used to provide you with the services and information
              you request, to communicate with you about our project updates, and to improve our
              website and customer service. We do not sell or lease your personal information to
              third parties.
            </p>
          </FadeUp>
          ...
          <FadeUp delay={0.2} className="space-y-4">
            ...
            <p className="text-[0.95rem] leading-[1.8]">
              Our website may use cookies to enhance your experience. You can choose to set your web
