  ...
  head: () => ({
    meta: [
      { title: "Terms of Use — Pura Vida Villas | EarthAroma" },
      {
        name: "description",
        content:
          "Terms of Use for the Pura Vida Villas website. By accessing this site, you agree to comply with our terms and conditions.",
      },
    ],
  }),
        ...
        <div className="mx-auto max-w-4xl space-y-10 text-ink-mid">
          <FadeUp className="space-y-4">
            ...
            <p className="text-[0.95rem] leading-[1.8]">
              The services that Pura Vida Villas provides to you are subject to the following Terms
              of Use. We reserve the right to update these terms at any time without notice to you.
            </p>
          </FadeUp>
          ...
          <FadeUp delay={0.1} className="space-y-4">
            ...
            <p className="text-[0.95rem] leading-[1.8]">
              ...
              the property of Pura Vida Villas or its content suppliers and is protected by
              international copyright laws. Unauthorized use of any content is strictly prohibited.
            </p>
          </FadeUp>
          ...
          <FadeUp delay={0.15} className="space-y-4">
            ...
            <p className="text-[0.95rem] leading-[1.8]">
              You agree to use the website only for lawful purposes. You are prohibited from posting
              or transmitting any unlawful, threatening, libelous, defamatory, obscene, or otherwise
          ...
          <FadeUp delay={0.2} className="space-y-4">
            ...
            <p className="text-[0.95rem] leading-[1.8]">
              In no event shall Pura Vida Villas be liable for any damages whatsoever arising out of
              or in connection with the use or performance of information available from this
              website.
            </p>
          </FadeUp>
